...
class CustomDummyData {
  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
      ...
      stock: 50,
      price: 55.99,
      thumbnail: CustomImages.productImage8,
      description:
    ...
    ProductModel(
      ...
      salePrice: 7.99,
      price: 8.99,
      thumbnail: CustomImages.productImage9,
      description:
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage11,
      sku: 'BATA-SOCKS',
      categoryId: '9',
      isFeatured: true,
      brand: brands[3],
    ...
    ProductModel(
      ...
      price: 79.99,
      salePrice: 71.99,
      thumbnail: CustomImages.productImage16a,
      images: [CustomImages.productImage16b],
      stock: 153,
      description:
    ...
    ProductModel(
      ...
      stock: 19,
      brand: brands[5],
      thumbnail: CustomImages.productImage17,
      description:
    ...
    ProductModel(
      ...
      price: 59.99,
      salePrice: 49.99,
      thumbnail: CustomImages.productImage19a,
      images: [CustomImages.productImage19b],
      stock: 12,
      brand: brands[10],
      categoryId: '10',
      description:
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage20,
      price: 44.99,
      salePrice: 39.99,
      stock: 43,
      brand: brands[3],
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage24,
      price: 59.99,
      salePrice: 48.99,
      stock: 43,
      brand: brands[9],
    ...
    ProductModel(
      ...
      price: 29.99,
      salePrice: 26.99,
      thumbnail: CustomImages.productImage25,
      stock: 23,
      brand: brands[5],
      description:
    ...
    ProductModel(
      ...
      price: 49.99,
      salePrice: 44.99,
      thumbnail: CustomImages.productImage26,
      stock: 23,
      brand: brands[7],
      description:
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage29,
      stock: 3,
      price: 9.99,
      salePrice: 7.56,
      description:
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage31,
      price: 69.99,
      salePrice: 52.99,
      stock: 2,
      description:
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage34,
      price: 1399.99,
      salePrice: 1268.99,
      stock: 76,
      description:
    ...
    ProductModel(
      ...
      price: 1599,
      thumbnail: CustomImages.productImage35,
      salePrice: 1497.99,
      stock: 29,
      description:
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage37,
      brand: brands[4],
      categoryId: '17',
      sku: "KEYBOARD-BLOODY",
    ),
    ...
    ProductModel(
      ...
      salePrice: 144.99,
      stock: 22,
      thumbnail: CustomImages.productImage41,
      description:
    ...
    ProductModel(
      ...
      price: 179.99,
      thumbnail: CustomImages.productImage42,
      stock: 23,
      brand: brands[4],
      description:
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage46,
      stock: 21,
      price: 39.99,
      salePrice: 37.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage47,
      stock: 21,
      price: 39.99,
      productType: 'ProductType.single',
      categoryId: '11',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage48,
      stock: 21,
      price: 59.99,
      salePrice: 52.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage50,
      stock: 21,
      price: 499.99,
      salePrice: 456.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage51,
      stock: 21,
      price: 599.99,
      salePrice: 576.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage52,
      stock: 21,
      price: 89.99,
      salePrice: 75.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage53,
      stock: 21,
      price: 399.99,
      salePrice: 376.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage54,
      stock: 2,
      price: 60,
      productType: 'ProductType.single',
      categoryId: '17',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage55,
      stock: 2,
      price: 299.99,
      salePrice: 275.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage56,
      stock: 2,
      price: 180,
      salePrice: 177,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage57,
      stock: 2,
      price: 49,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage58,
      stock: 2,
      price: 799.99,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage59,
      stock: 2,
      price: 1299,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage60,
      stock: 2,
      price: 999,
      productType: 'ProductType.single',
      categoryId: '20',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage62,
      stock: 2,
      price: 259,
      productType: 'ProductType.single',
      categoryId: '21',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage63,
      stock: 2,
      price: 249,
      salePrice: 212,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage64,
      stock: 2,
      price: 155,
      salePrice: 128,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage65,
      stock: 2,
      price: 620,
      salePrice: 615,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage66,
      stock: 2,
      price: 15,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
      ...
      thumbnail: CustomImages.productImage68,
      stock: 2,
      price: 27,
      productType: 'ProductType.single',
      categoryId: '9',
  ...
  static final List<PromoCodeModel> promoCodes = [
    ...
    PromoCodeModel(
      id: '2',
      code: 'FLAT50',
      name: 'Flat ${CustomText.currency}50 Off',
      discount: 50,
    ...
    PromoCodeModel(
      id: '6',
      code: 'BIGSAVE100',
      name: 'Big Save ${CustomText.currency}100 Off',
      discount: 100,
      discountType: DiscountType.fixed,
      startDate: DateTime.now(),
    ...
    PromoCodeModel(
      id: '9',
      code: 'DIWALI500',
      name: 'Diwali Mega ${CustomText.currency}500 Off',
      discount: 500,
      discountType: DiscountType.fixed,
      startDate: DateTime.now(),
    ...
    PromoCodeModel(
      id: '10',
      code: 'SAVE70',
      name: 'Save ${CustomText.currency}70 Instantly',
      discount: 70,
      discountType: DiscountType.fixed,
