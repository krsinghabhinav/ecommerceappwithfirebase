...
class CustomeSizes {
  ...
  static const double mlg = 20.0; //extra large
  ...
  // Card Sizes
  static const double homePrimaryHeaderHeight = 320; // 320
  static const double stirePrimaryHeaderHeight = 320; // 320
  static const double storePrimaryHeaderHeight = 170.0; // 170
  static const double profilePrimaryHeaderHeight = 200.0; // 170
